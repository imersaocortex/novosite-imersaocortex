...
const ShaderBackground = ({ className = "" }: ShaderBackgroundProps) => {
  ...
  // Fragment shader adapted with brand green palette (#6CC417)
  const fsSource = `
    ...
    // Brand green line color: #6CC417 = rgb(0.42, 0.77, 0.09)
    const vec4 lineColor = vec4(0.42, 0.77, 0.09, 1.0);
    ...
    void main() {
      ...
      // Dark green brand background: near #050505 with subtle green tint
      vec4 bgColor1 = vec4(0.03, 0.06, 0.02, 1.0);
      vec4 bgColor2 = vec4(0.05, 0.10, 0.02, 1.0);
